                ...
                <div class="col-lg-12 pt-5 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center">
                    ...
                    <form data-aos="fade-up" data-aos-delay="400"
                        ...
                        <div class="fb-grouplabel"
                            style="text-align: center; background-color: lightblue; margin-top: 0; height:50px; padding-top: 7px; border-block-end: 3px solid #0071bc">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 pt-5 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center">
                    <form data-aos="fade-up" data-aos-delay="400"
                        class="MyStyle_create_edit_form fb-toplabel fb-100-item-column selected-object" id="docContainer"
                        action="{{ route('admin.teacherlesson.update', $teacherlesson->id) }}" method="post">
                        @csrf
                                ...
                                <div class="fb-item fb-100-item-column" id="item50">
                                    ...
                                    <div class="fb-dropdown">
                                        <select name="state" id="state"
                                            style="font-family: B Nazanin; font-size: 18px; font-weight: bold; height: 40px;">
                                            <option value="1"
                                                {{ old('state', $teacherlesson->state) == 1 ? 'selected' : '' }}>فعال
                                            </option>
                                            <option value="0"
                                                {{ old('state', $teacherlesson->state) == 0 ? 'selected' : '' }}>غیر فعال
                                            </option>
                                        </select>
                                ...
                                <div class="fb-item fb-100-item-column" id="item49">
                                    ...
                                    <div class="fb-input-box">
                                        <textarea name="description" id="description" cols="30" rows="10" data-hint="" autocomplete="off"
                                            style="font-family: B Nazanin; font-size: 18px; font-weight: bold;" value="{{ old('description') }}" />{{ $teacherlesson->description }}</textarea>
