...
@section('content')
    <div class="breadcrumb">
        <div>
            ...
            &nbsp; / &nbsp;
            <span style="color: gray">ایجاد رشته تحصیلی جدید</span>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-lg-12 pt-5 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center">
                    <form data-aos="fade-up" data-aos-delay="400"
                        ...
                        action="{{ route('admin.major.store') }}" method="post">
                        @csrf
                        ...
                        <div class="section" id="section1">
                            <div class="column ui-sortable" id="column1">
                                ...
                                <div class="fb-item fb-100-item-column" id="item49">
                                    <div class="fb-grouplabel">
                                        <label id="description" style="font-weight: bold; display: inline;">شرح رشته تحصیلی</label>
                                    </div>
