...
@section('content')
    <div class="breadcrumb">
        <div>
            ...
            &nbsp; / &nbsp;
            <span style="color: gray">ویرایش گروه درسی موجود</span>
        </div>
    </div>
                            ...
                            <div class="column ui-sortable" id="column1">
                                <div class="fb-item fb-50-item-column" id="item49">
                                    <div class="fb-grouplabel">
                                        <label id="name" style="font-weight: bold; display: inline;">عنوان گروه
                                            درسی</label>
                                    </div>
                                ...
                                <div class="fb-item fb-50-item-column" id="item50">
                                    ...
                                    <div class="fb-dropdown">
                                        <select name="state" id="state"
                                            ...
                                            <option value="1"
                                                {{ old('state', $lessongroup->state) == 1 ? 'selected' : '' }}>
                                                فعال</option>
                                            <option value="0"
                                                {{ old('state', $lessongroup->state) == 0 ? 'selected' : '' }}>
                                                غیر فعال</option>
                                        </select>
                                ...
                                <div class="fb-item fb-100-item-column" id="item49">
                                    <div class="fb-grouplabel">
                                        <label id="description" style="font-weight: bold; display: inline;">شرح گروه
                                            درسی</label>
                                    </div>

                                    <div class="fb-input-box">
                                        <textarea name="description" id="description" cols="30" rows="10" data-hint="" autocomplete="off"
                                            style="font-family: B Nazanin; font-size: 18px; font-weight: bold;" value="{{ old('description') }}" />{{ $lessongroup->description }}</textarea>
